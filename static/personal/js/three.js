...
renderer.setClearColor("rgb(252,252,252)"); // Backgrond Color - Blue
...
const material = new THREE.MeshBasicMaterial( {color: '#000000'} ); // Maps the normal vectors to RGB colors
